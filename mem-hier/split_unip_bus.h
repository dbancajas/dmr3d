...
/* $Id: split_unip_bus.h,v 1.1.1.1.10.1 2005/03/10 17:46:32 pwells Exp $
 *
...
#ifndef _SPLIT_UNIP_BUS_H_
#define _SPLIT_UNIP_BUS_H_



// main memory
template <class prot_t, class msg_t>
class split_unip_bus_t : public device_t {
	
 public:
	typedef event_t<msg_t, split_unip_bus_t> _event_t;

	split_unip_bus_t(string name, uint32 num_uplinks, uint32 num_downlinks);	
...
#include "split_unip_bus.cc"

#endif // _SPLIT_UNIP_BUS_H_
