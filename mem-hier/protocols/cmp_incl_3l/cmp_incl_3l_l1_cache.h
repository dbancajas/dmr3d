...
/* $Id: cmp_incl_3l_l1_cache.h,v 1.1.2.3 2006/03/04 18:55:40 kchak Exp $
 *
...
#ifndef _CMP_INCL_3L_L1_CACHE_H_
#define _CMP_INCL_3L_L1_CACHE_H_

#include "cmp_incl_3l_l1.h"

////////////////////////////////////////////////////////////////////////////////
// CMP exclusive L3 cache line
class cmp_incl_3l_l1_line_t : public line_t, public cmp_incl_3l_l1_protocol_t {
...
class cmp_incl_3l_l1_cache_t : public tcache_t<cmp_incl_3l_l1_protocol_t>
{

public:
	cmp_incl_3l_l1_cache_t(string name, cache_config_t *conf, uint32 id, 
...
#endif /* _CMP_INCL_3L_L1_CACHE_H_ */
