...
/* $Id: cmp_incl_3l_msg.h,v 1.1.2.2 2005/11/29 19:11:49 pwells Exp $
 *
 * description:    
 * initial author: 
 *
...
#ifndef _CMP_INCL_3L_MSG_H_
#define _CMP_INCL_3L_MSG_H_

#include "interconnect_msg.h"
#include "cmp_incl_3l.h"

class cmp_incl_3l_msg_t : public interconnect_msg_t, public cmp_incl_3l_protocol_t {
	
public:
	// Constructor
 	cmp_incl_3l_msg_t(mem_trans_t *trans, addr_t addr, uint32 size,
