...
/* $Id: cmp_incl_l2_cache.h,v 1.1.2.18 2006/12/12 18:36:13 pwells Exp $
 *
...
#ifndef _CMP_INCL_L2_CACHE_H_
#define _CMP_INCL_L2_CACHE_H_

#include "cmp_incl_l2.h"

////////////////////////////////////////////////////////////////////////////////
// CMP inclusive L2 cache line
class cmp_incl_l2_line_t : public line_t, public cmp_incl_l2_protocol_t {
...
public:
	...
	static const uint32 MAX_SHARERS = 64;
...
class cmp_incl_l2_cache_t : public tcache_t<cmp_incl_l2_protocol_t>
{

public:
	cmp_incl_l2_cache_t(string name, cache_config_t *conf, uint32 id, 
	...
	uint32 get_sharer_cpu_id(uint32 sharer);
...
protected:
    ...
    st_entry_t *stat_num_as_user_fwd;
    ...
    bool is_no_sharer(tfn_info_t *t, tfn_ret_t *ret);
