...
/* $Id: cmp_incl_msg.h,v 1.1.2.3 2005/06/02 19:08:10 pwells Exp $
 *
 * description:    
 * initial author: 
 *
...
#ifndef _CMP_INCL_MSG_H_
#define _CMP_INCL_MSG_H_

#include "interconnect_msg.h"
#include "cmp_incl.h"

class cmp_incl_msg_t : public interconnect_msg_t, public cmp_incl_protocol_t {
	
public:
	// Constructor
 	cmp_incl_msg_t(mem_trans_t *trans, addr_t addr, uint32 size,
