...
/* $Id: unip_two_l2.h,v 1.1.2.1 2005/08/24 19:20:07 pwells Exp $
 *
...
#ifndef _UNIP_TWO_L2_H_
#define _UNIP_TWO_L2_H_
...
class unip_two_l2_protocol_t : public unip_two_protocol_t {
public:
	/// States
	...
	static const uint32 StateInv_Write 	 = 4;
	static const uint32 StateClean       = 5;
	static const uint32 StateDirty       = 6;
	static const uint32 StateMax         = 7;
	
	/// Actions
	static const uint32 ActionReplace       = 0;
	static const uint32 ActionIRead         = 1;
	static const uint32 ActionDRead         = 2;
	static const uint32 ActionDWrite        = 3;
	static const uint32 ActionRecvData      = 4;
	static const uint32 ActionFlush         = 5;
	static const uint32 ActionMax           = 6;
	
	/// Links
	static const uint8 icache_link = 0;  
	static const uint8 dcache_link = 1;  
	static const uint8 mainmem_link = 2;  
