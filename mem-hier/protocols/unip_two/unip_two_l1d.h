...
/* $Id: unip_two_l1d.h,v 1.1.2.1 2005/08/24 19:20:07 pwells Exp $
 *
...
#ifndef _UNIP_TWO_L1D_H_
#define _UNIP_TWO_L1D_H_
...
class unip_two_l1d_protocol_t : public unip_two_protocol_t {
public:
	/// States
	...
	static const uint32 StatePresent     = 4;
	static const uint32 StateMax         = 5;
	
	/// Actions
	static const uint32 ActionReplace       = 0;
	static const uint32 ActionProcRead      = 1;
	static const uint32 ActionProcWrite     = 2;
	static const uint32 ActionRecvData      = 3;
	static const uint32 ActionRecvInv       = 4;
    static const uint32 ActionPrefetch      = 5;
