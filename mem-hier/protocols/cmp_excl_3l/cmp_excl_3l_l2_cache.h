...
/* $Id: cmp_excl_3l_l2_cache.h,v 1.1.2.4 2006/03/04 18:55:40 kchak Exp $
 *
...
#ifndef _CMP_EXCL_3L_L2_CACHE_H_
#define _CMP_EXCL_3L_L2_CACHE_H_

#include "cmp_excl_3l_l2.h"

////////////////////////////////////////////////////////////////////////////////
// CMP exclusive L3 cache line
class cmp_excl_3l_l2_line_t : public line_t, public cmp_excl_3l_l2_protocol_t {
friend class cmp_excl_3l_l2_cache_t;
...
class cmp_excl_3l_l2_cache_t : public tcache_t<cmp_excl_3l_l2_protocol_t>
{

public:
	cmp_excl_3l_l2_cache_t(string name, cache_config_t *conf, uint32 id, 
    ...
    void set_l2dir_array_ptr(cmp_excl_3l_l2dir_array_t *);
...
protected:
    ...
    cmp_excl_3l_l2dir_array_t *l2dir_array_ptr;
    conf_object_t *cpu;
