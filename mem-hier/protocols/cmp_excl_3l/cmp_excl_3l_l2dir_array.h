...
/* $Id: cmp_excl_3l_l2dir_array.h,v 1.1.2.5 2006/03/03 23:33:02 kchak Exp $
 *
...
#ifndef _CMP_EXCL_3L_L2DIR_ARRAY_H_
#define _CMP_EXCL_3L_L2DIR_ARRAY_H_

#include "cmp_excl_3l_l2dir.h"

////////////////////////////////////////////////////////////////////////////////
// CMP exclusive L2DIR cache line
class cmp_excl_3l_l2dir_line_t : public line_t, public cmp_excl_3l_l2dir_protocol_t {
...
class cmp_excl_3l_l2dir_array_t : public tcache_t<cmp_excl_3l_l2dir_protocol_t>
{

public:
	cmp_excl_3l_l2dir_array_t(string name, cache_config_t *conf, uint32 id, 
