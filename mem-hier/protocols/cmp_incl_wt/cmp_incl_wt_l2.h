...
/* $Id: cmp_incl_wt_l2.h,v 1.1.2.9 2005/07/29 20:38:10 pwells Exp $
 *
...
#ifndef _CMP_INCL_WT_L2_H_
#define _CMP_INCL_WT_L2_H_
...
class cmp_incl_wt_l2_protocol_t : public cmp_incl_wt_protocol_t {
public:
	/// States
	...
	static const uint32 StateShToInv     = 6;
	...
	/// Typedefs
	typedef cmp_incl_wt_l2_line_t                            prot_line_t;
	typedef transfn_return_t<uint32, prot_line_t>         tfn_ret_t;
	typedef transfn_info_t<uint32, uint32, prot_line_t>   tfn_info_t;
    typedef cmp_incl_wt_l2_cache_t                           cache_type_t;
	typedef cmp_incl_wt_msg_t                                upmsg_t;
