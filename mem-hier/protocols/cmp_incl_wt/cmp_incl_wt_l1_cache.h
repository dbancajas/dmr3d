...
/* $Id: cmp_incl_wt_l1_cache.h,v 1.1.2.8 2005/11/22 19:33:15 kchak Exp $
 *
...
#ifndef _CMP_INCL_WT_L1_CACHE_H_
#define _CMP_INCL_WT_L1_CACHE_H_

#include "cmp_incl_wt_l1.h"

////////////////////////////////////////////////////////////////////////////////
// CMP inclusive L2 cache line
class cmp_incl_wt_l1_line_t : public line_t, public cmp_incl_wt_l1_protocol_t {
...
class cmp_incl_wt_l1_cache_t : public tcache_t<cmp_incl_wt_l1_protocol_t>
{

public:
	cmp_incl_wt_l1_cache_t(string name, cache_config_t *conf, uint32 id, 
    ...
    void set_L2_cache_ptr(cmp_incl_wt_l2_cache_t *);
...
protected:
    ...
    cmp_incl_wt_l2_cache_t *l2_cache_ptr;
    conf_object_t *cpu;
...
#endif /* _CMP_INCL_WT_L1_CACHE_H_ */
