...
#define Qparam 1.602E-19    /* Charge of an Electron     */
#define Eox       3.5E-11
...
class leakage_t {
    ...
    private:
        ...
        public:
            ...
            void precalc_leakage_params(double Volt,double tox0);
            void init_tech_params(double tech);
            void init_tech_params_default_process();//v4.1
            
            
            double optimized_simplified_cmos_leakage(double naspect_ratio,double paspect_ratio,
                double nVth0, double pVth0, double * nleak, double * pleak);
            int32 leakage_params() { return have_leakage_params;}
            double get_Vt_bit_nmos_low() { return Vt_bit_nmos_low;}
            double get_Vthn() { return Vthn;}
            double get_Vt_bit_pmos_low() { return Vt_bit_pmos_low;}
            double get_Vthp() { return Vthp;}
